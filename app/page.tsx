  ...
  return (
    <div className="mt-4 bg-blue-50 rounded-xl p-4 border border-blue-100">
      <div className="flex items-center justify-between mb-2">
        <span className="text-sm font-semibold text-blue-700 truncate max-w-xs">📄 {fileName}</span>
        <span className="text-sm font-bold text-blue-700 ml-2">{pct}%</span>
      </div>
              ...
              <button onClick={handleSummarize} disabled={loading}
                ...
                {loading
                  ? <><Loader2 className="w-5 h-5 animate-spin" />
                    {status || (progress.total > 0 ? `${progress.completed} of ${progress.total} sections done...` : 'Reading PDF...')}</>
